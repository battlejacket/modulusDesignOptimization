...
class AdvectionDiffusionS(PDE):
    ...
    name = "AdvectionDiffusionS"

    def __init__(
        self, domain= "", T="T", D="D", Q=0, rho="rho", dim=3, time=False, mixed_form=False
    ):
        # set params
        self.domain=domain
        self.T = T
        ...
        # velocity componets
        u = Function("u_" + self.domain)(*input_variables)
        v = Function("v_" + self.domain)(*input_variables)
        w = Function("w_" + self.domain)(*input_variables)
