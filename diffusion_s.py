...
class DiffusionInterfaceHTC(PDE):
    """
    ...
    def __init__(self, T_1, T_2, D_1, HTC, dim=3, time=True):
        # set params
        self.T_1 = T_1
        self.T_2 = T_2
        self.D_1 = D_1
        ...
        flux_2 = self.HTC*(T_2 - T_1)
        
        self.equations["diffusion_interface_HTC_" + self.T_1] = (
            flux_1 - flux_2
        )
